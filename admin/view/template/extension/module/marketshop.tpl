...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      ...
      <button type="submit" form="form-marketshop" id="save_stay" name="save_stay" value="1" class="btn btn-success"><i class="fa fa-check"></i> <?php echo $button_save_stay; ?></button>
        <button type="submit" form="form-marketshop" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i> <?php echo $button_save; ?></button>
                  ...
                  <div class="tab-content">
                    ...
                    <div id="tab8-language-<?php echo $language['language_id']; ?>" class="tab-pane">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                        <textarea name="marketshop_custom_block_top_content[<?php echo $language['language_id']; ?>][description]" class="form-control summernote" id="input-description8<?php echo $language['language_id']; ?>"><?php echo isset($marketshop_custom_block_top_content[$language['language_id']]['description']) ? $marketshop_custom_block_top_content[$language['language_id']]['description'] : ''; ?></textarea>
                        </div>
                      </div>
                    </div>
                    <?php } ?>
                  ...
                  <div class="tab-content">
                    ...
                    <div id="tab9-language-<?php echo $language['language_id']; ?>" class="tab-pane">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                        <textarea name="marketshop_custom_block2_top_content[<?php echo $language['language_id']; ?>][description]" class="form-control summernote" id="input-description9<?php echo $language['language_id']; ?>"><?php echo isset($marketshop_custom_block2_top_content[$language['language_id']]['description']) ? $marketshop_custom_block2_top_content[$language['language_id']]['description'] : ''; ?></textarea>
                        </div>
                      </div>
                    </div>
                    <?php } ?>
                  ...
                  <div class="tab-content">
                    ...
                    <div class="tab-pane" id="tab2-language-<?php echo $language['language_id']; ?>">
                      ...
                      <div class="form-group">
                        <label class="col-sm-2 control-label" ><?php echo $entry_custom_column; ?></label>
                        <div class="col-sm-10">
                        <textarea id="input-description2<?php echo $language['language_id']; ?>" name="marketshop_custom_block_content[<?php echo $language['language_id']; ?>][description]" class="form-control summernote"><?php echo isset($marketshop_custom_block_content[$language['language_id']]['description']) ? $marketshop_custom_block_content[$language['language_id']]['description'] : ''; ?></textarea>
                        </div>
                      </div>
                    </div>
                    <?php } ?>
                ...
                <div class="tab-content">
                  ...
                  <div class="tab-pane" id="tab4-language-<?php echo $language['language_id']; ?>">
                    ...
                    <div class="form-group">
                      <label class="col-sm-2 control-label" ><?php echo $entry_custom_column; ?></label>
                      <div class="col-sm-10">                        
                        <textarea id="input-description4<?php echo $language['language_id']; ?>" name="marketshop_custom_block2_content[<?php echo $language['language_id']; ?>][description]" class="form-control summernote"><?php echo isset($marketshop_custom_block2_content[$language['language_id']]['description']) ? $marketshop_custom_block2_content[$language['language_id']]['description'] : ''; ?></textarea>
                      </div>
                    </div>
                  </div>
                  <?php } ?>
                ...
                <div class="tab-content">
                  ...
                  <div class="tab-pane" id="tab5-language-<?php echo $language['language_id']; ?>">
                    ...
                    <div class="form-group">
                      <label class="col-sm-2 control-label" ><?php echo $entry_custom_column; ?></label>
                      <div class="col-sm-10">
                      <textarea id="input-description5<?php echo $language['language_id']; ?>" name="marketshop_custom_block3_content[<?php echo $language['language_id']; ?>][description]" class="form-control summernote"><?php echo isset($marketshop_custom_block3_content[$language['language_id']]['description']) ? $marketshop_custom_block3_content[$language['language_id']]['description'] : ''; ?></textarea>
                      </div>
                    </div>
                  </div>
                  <?php } ?>
                      ...
                      <div class="tab-content">
                        ...
                        <div id="tab10-language-<?php echo $language['language_id']; ?>" class="tab-pane">
                          <div class="form-group">
                            <label class="col-sm-2 control-label" ><?php echo $entry_custom_column; ?></label>
                            <div class="col-sm-10">
                            <textarea name="marketshop_about_details[<?php echo $language['language_id']; ?>][description]" class="form-control summernote" id="input-description10<?php echo $language['language_id']; ?>"><?php echo isset($marketshop_about_details[$language['language_id']]['description']) ? $marketshop_about_details[$language['language_id']]['description'] : ''; ?></textarea>
                            </div>
                          </div>
                        </div>
                        <?php } ?>
                ...
                <div class="tab-content">
                  ...
                  <div class="tab-pane" id="tab7-language-<?php echo $language['language_id']; ?>">
                    <div class="form-group">
                      <label class="col-sm-2 control-label" ><?php echo $entry_custom_column; ?></label>
                      <div class="col-sm-10">
                      <textarea name="marketshop_powered[<?php echo $language['language_id']; ?>][description]" class="form-control summernote" id="input-description7<?php echo $language['language_id']; ?>"><?php echo isset($marketshop_powered[$language['language_id']]['description']) ? $marketshop_powered[$language['language_id']]['description'] : ''; ?></textarea>
                      </div>
                    </div>
                  </div>
                  <?php } ?>
                ...
                <div class="tab-content">
                  ...
                  <div class="tab-pane" id="tab3-language-<?php echo $language['language_id']; ?>">
                    <div class="form-group">
                      <label class="col-sm-2 control-label" ><?php echo $entry_custom_column; ?></label>
                      <div class="col-sm-10">
                      <textarea name="marketshop_custom_column_footer[<?php echo $language['language_id']; ?>][description]" class="form-control summernote" id="input-description3<?php echo $language['language_id']; ?>"><?php echo isset($marketshop_custom_column_footer[$language['language_id']]['description']) ? $marketshop_custom_column_footer[$language['language_id']]['description'] : ''; ?></textarea>
                      </div>
                    </div>
                  </div>
                  <?php } ?>
                ...
                <div class="tab-content">
                  ...
                  <div class="tab-pane" id="tab11-language-<?php echo $language['language_id']; ?>">
                    <div class="form-group">
                      <label class="col-sm-2 control-label" ><?php echo $entry_custom_column; ?></label>
                      <div class="col-sm-10">
                      <textarea name="marketshop_video_box_content[<?php echo $language['language_id']; ?>][description]" class="form-control summernote" id="input-description11<?php echo $language['language_id']; ?>"><?php echo isset($marketshop_video_box_content[$language['language_id']]['description']) ? $marketshop_video_box_content[$language['language_id']]['description'] : ''; ?></textarea>
                      </div>
                    </div>
                  </div>
                  <?php } ?>
                  ...
                  <div class="tab-content">
                    ...
                    <div id="tab6-language-<?php echo $language['language_id']; ?>" class="tab-pane">
                      <div class="form-group">
                        <label class="col-sm-2 control-label" ><?php echo $entry_custom_column; ?></label>
                        <div class="col-sm-10">
                        <textarea name="marketshop_custom_column[<?php echo $language['language_id']; ?>][description]" class="form-control summernote" id="input-description6<?php echo $language['language_id']; ?>"><?php echo isset($marketshop_custom_column[$language['language_id']]['description']) ? $marketshop_custom_column[$language['language_id']]['description'] : ''; ?></textarea>
                        </div>
                      </div>
                    </div>
                    <?php } ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select class="form-control" name="marketshop_pattern_overlay" style="padding:5px;">
                ...
                <?php 
                  for ($i = 1; $i <= 53; $i++) { 
									($marketshop_pattern_overlay == $i) ? $currentpat = 'selected' : $currentpat = '';
								?>
          ...
          <table class="table table-hover">
            ...
            <tr>
              ...
              <td><select class="form-control" name="marketshop_body_font">
                  ...
                  <?php ($fv ==  $marketshop_body_font) ? $currentfont = 'selected' : $currentfont=''; ?>
            ...
            <tr>
              ...
              <td><select class="form-control" name="marketshop_top_bar_font">
                  <?php foreach ($fonts as $fv => $fc) { ?>
                  <?php ($fv ==  $marketshop_top_bar_font) ? $currentfont = 'selected' : $currentfont=''; ?>
                  <option value="<?php echo $fv; ?>" <?php echo $currentfont; ?> ><?php echo $fc; ?></option>
                  <?php } ?>
                </select></td>
            ...
            <tr>
              ...
              <td><select class="form-control" name="marketshop_main_menu_font">
                  <?php foreach ($fonts as $fv => $fc) { ?>
                  <?php ($fv ==  $marketshop_main_menu_font) ? $currentfont = 'selected' : $currentfont=''; ?>
                  <option value="<?php echo $fv; ?>" <?php echo $currentfont; ?> ><?php echo $fc; ?></option>
                  <?php } ?>
                </select></td>
            ...
            <tr>
              ...
              <td><select class="form-control" name="marketshop_title_font">
                  <?php foreach ($fonts as $fv => $fc) { ?>
                  <?php ($fv ==  $marketshop_title_font) ? $currentfont = 'selected' : $currentfont=''; ?>
                  <option value="<?php echo $fv; ?>" <?php echo $currentfont; ?> ><?php echo $fc; ?></option>
                  <?php } ?>
                </select></td>
            ...
            <tr>
              ...
              <td><select class="form-control" name="marketshop_secondary_titles_font">
                  <?php foreach ($fonts as $fv => $fc) { ?>
                  <?php ($fv ==  $marketshop_secondary_titles_font) ? $currentfont = 'selected' : $currentfont=''; ?>
                  <option value="<?php echo $fv; ?>" <?php echo $currentfont; ?> ><?php echo $fc; ?></option>
                  <?php } ?>
                </select></td>
            ...
            <tr>
              ...
              <td><select class="form-control" name="marketshop_footer_titles_font">
                  <?php foreach ($fonts as $fv => $fc) { ?>
                  <?php ($fv ==  $marketshop_footer_titles_font) ? $currentfont = 'selected' : $currentfont=''; ?>
                  <option value="<?php echo $fv; ?>" <?php echo $currentfont; ?> ><?php echo $fc; ?></option>
                  <?php } ?>
                </select></td>
