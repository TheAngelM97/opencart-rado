...
<script type="text/javascript"><!--
	...
	function getOfficeByOfficeCode(office_code) {
		if (parseInt(office_code)) {
			$.ajax({
				url: 'index.php?route=extension/shipping/econt/getOfficeByOfficeCode&token=<?php echo $token; ?>',
				type: 'POST',
...
function refreshData() {
	...
	$.ajax({
		url: 'index.php?route=extension/shipping/econt/refreshData&token=<?php echo $token; ?>',
		type: 'POST',
...
function getProfile() {
	...
	$.ajax({
		url: 'index.php?route=extension/shipping/econt/getProfile&token=<?php echo $token; ?>',
		type: 'POST',
...
function getOfficesByCityId(aps) {
	...
	$.ajax({
		url: 'index.php?route=extension/shipping/econt/getOfficesByCityId&token=<?php echo $token; ?>',
		type: 'POST',
...
function getOffice(aps) {
	...
	$.ajax({
		url: 'index.php?route=extension/shipping/econt/getOffice&token=<?php echo $token; ?>',
		type: 'POST',
...
function getKeyWords() {
	...
	$.ajax({
		url: 'index.php?route=extension/shipping/econt/getClients&token=<?php echo $token; ?>',
		type: 'POST',
		data: 'username=' + encodeURIComponent($('#econt_username').val()) + '&password=' + encodeURIComponent($('#econt_password').val()) + '&test=' + encodeURIComponent($('#econt_test').val()),
		dataType: 'json',
		success: function(data) {
...
function autocompleteAddress(index) {
	...
	$('#econt_city_' + index).autocomplete({
		'source': function(request, response) {
			$.ajax({
				url: 'index.php?route=extension/shipping/econt/getCitiesByName&token=<?php echo $token; ?>&filter_name=' + encodeURIComponent(request),
				dataType: 'json',
	...
	$('#econt_quarter_' + index).autocomplete({
		'source': function(request, response) {
			$.ajax({
				url: 'index.php?route=extension/shipping/econt/getQuartersByName&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request) + '&city_id=' +  encodeURIComponent($('#econt_city_id_' + index).val()),
				dataType: 'json',
				success: function(json) {
					response($.map(json, function(item) {
						return {
	...
	$('#econt_street_' + index).autocomplete({
		'source': function(request, response) {
			$.ajax({
				url: 'index.php?route=extension/shipping/econt/getStreetsByName&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request) + '&city_id=' +  encodeURIComponent($('#econt_city_id_' + index).val()),
				dataType: 'json',
				success: function(json) {
					response($.map(json, function(item) {
						return {
