...
<script type="text/javascript"><!--
	...
	$('#quarter').autocomplete({
		'source': function(request, response) {
			$.ajax({
				url: 'index.php?route=extension/shipping/econt/getQuartersByName&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request) + '&city_id=' +  encodeURIComponent($('#city_id').val()),
				dataType: 'json',
				success: function(json) {
					response($.map(json, function(item) {
						return {
	...
	$('#street').autocomplete({
		'source': function(request, response) {
			$.ajax({
				url: 'index.php?route=extension/shipping/econt/getStreetsByName&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request) + '&city_id=' +  encodeURIComponent($('#city_id').val()),
				dataType: 'json',
				success: function(json) {
					response($.map(json, function(item) {
						return {
