...
<header id="header" class="navbar navbar-static-top">
  <div class="navbar-header">
    ...
    <?php } ?>
    <a href="<?php echo $home; ?>" class="navbar-brand"><img src="view/image/weband-logo.png" alt="<?php echo $heading_title; ?>" title="<?php echo $heading_title; ?>" style="width: 140px;" /></a></div>
  <?php if ($logged) { ?>
