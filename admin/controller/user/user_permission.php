 ...
 'module/d_shopunity');
	...
	protected function getForm() {
		...
		foreach ($files as $file) {
			...
			if (!in_array($permission, $ignore) && !in_array($permission, $this->ignore)) {
