	...
	<div class="login-btn-group">
		...
		<% if(parseInt(model.config.option.guest.display)){ %>
			<div class="btn-group" role="group">
				<label class="btn <%= model.account == 'guest' ? 'btn-primary active' : 'btn-default' %>"  style="overflow: hidden;">
		...
		<% if(parseInt(model.config.option.register.display)){ %>
			<div class="btn-group" role="group">
				<label  class="btn <%= model.account == 'register' ? 'btn-primary active' : 'btn-default' %> <%= parseInt(model.config.option.register.display) ? '' : 'hidden' %>" style="overflow: hidden;">
