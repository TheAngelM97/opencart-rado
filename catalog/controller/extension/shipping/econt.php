...
class ControllerExtensionShippingEcont extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['city_id'])) {
			...
			$cities = $this->model_extension_shipping_econt->getCitiesByName($city_name);
		...
		if ((!$data['office_city_aps_id'] || !$data['office_aps_code']) && $data['office_aps_id']) {
			$office_aps = $this->model_extension_shipping_econt->getOffice($data['office_aps_id']);
		...
		if ($data['office_city_aps_id']) {
			$data['offices_aps'] = $this->model_extension_shipping_econt->getOfficesByCityId($data['office_city_aps_id'], $this->delivery_type, 1);
		}
