...
<div class="content">
  <table width="100%">
    <tr>
      <td><?php echo $text_loading_num; ?> <?php echo $loading_num; ?></td>
      <td style="text-align: right;"><a onclick="location = '<?php echo $return_loading; ?>'" class="btn btn-primary"><span><?php echo $button_return_loading; ?></span></a></td>
    </tr>
  </table>
</div>
<?php } elseif ($blank_yes) { ?>
<div class="content">
  <table width="100%">
    <tr>
      <td><a href="<?php echo $blank_yes; ?>" target="_blank"><?php echo $text_blank_yes; ?></a></td>
    </tr>
  </table>
</div>
<?php } ?>
