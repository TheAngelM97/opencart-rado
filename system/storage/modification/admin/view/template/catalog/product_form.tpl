...
<?php 
  ...
  if (isset($product_manufacturer)) {
    if (!$product_manufacturer) {
      $product_manufacturer = array('name' => '', 'manufacturer_id' => '');
    }
  }
  else {
    $product_manufacturer = array('name' => '', 'manufacturer_id' => '');
...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
			...
			<div style="position: fixed; right: 20px; z-index: 100;">
      ...
      <div class="panel-body">
        ...
        <?php  }
          ...
          <div class="tab-content">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  <div class="form-group required">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="product_description[<?php echo $language['language_id']; ?>][name]" value="<?php if (isset($name)) { echo trim($name); } ?><?php echo isset($product_description[$language['language_id']]) ? trim($product_description[$language['language_id']]['name']) : ''; ?>" placeholder="<?php echo $entry_name; ?>" id="input-name<?php echo $language['language_id']; ?>" class="form-control" />
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="product_description[<?php echo $language['language_id']; ?>][short_description]" value="<?php echo isset($product_description[$language['language_id']]) ? trim($product_description[$language['language_id']]['short_description']) : ''; ?>" placeholder="<?php echo $entry_short_description; ?>" id="input-short-description<?php echo $language['language_id']; ?>" class="form-control">
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group required">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="product_description[<?php echo $language['language_id']; ?>][meta_title]" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['meta_title'] : ''; ?> <?php if(isset($name)) { echo $name; } ?>" placeholder="<?php echo $entry_meta_title; ?>" id="input-meta-title<?php echo $language['language_id']; ?>" class="form-control" />
			...
			<hr noshade size=7><div class="heading"><h1 style="color: orange;">Data</h1>
			
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-model"><?php echo $entry_model; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="model" value="<?php echo $model; ?><?php if(isset($productModel)) { echo $productModel; } ?>" placeholder="<?php echo $entry_model; ?>" id="input-model" class="form-control" />
                  <?php if ($error_model) { ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" name="sku" value="<?php echo $sku; ?><?php if(isset($productModel)) { echo $productModel; } ?>" placeholder="<?php echo $entry_sku; ?>" id="input-sku" class="form-control" />
                </div>
              </div>
              <div class="form-group">
			...
			<hr noshade size=7><div class="heading"><h1 style="color: orange;">Links</h1>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <?php 
                    if ($product_manufacturer['name'] && $product_manufacturer['manufacturer_id']) { ?>
                      <input type="text" name="manufacturer" value="<?php echo $manufacturer; ?> <?php echo $product_manufacturer['name'] ?>" placeholder="<?php echo $entry_manufacturer; ?>" id="input-manufacturer" class="form-control" />
                      <input type="hidden" name="manufacturer_id" value="<?php echo $product_manufacturer['manufacturer_id'] ?>" />
              <?php  }
                    else { ?>
			...
			<hr noshade size=7><div class="heading" style="display:none;"><h1 style="color: orange;">Attribute</h1>
			...
			<hr noshade size=7><div id="tab-option" class="heading"><h1 style="color: orange;">Option</h1>
			...
			<hr noshade size=7><div class="heading" style="display:none;"><h1 style="color: orange;">Recurring</h1>
			...
			<hr noshade size=7><div class="heading"><h1 style="color: orange;">Discount</h1>
			...
			<hr noshade size=7><div class="heading"><h1 style="color: orange;">Special</h1>
			...
			<hr noshade size=7><div class="heading"><h1 style="color: orange;">Image</h1>
			...
			<hr noshade size=7><div class="heading" style="display:none;"><h1 style="color: orange;">Reward</h1>
			...
			<hr noshade size=7><div class="heading" style="display:none;"><h1 style="color: orange;">Design</h1>
