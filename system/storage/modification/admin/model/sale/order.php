...
class ModelSaleOrder extends Model {
	...
	public function getOrders($data = array()) {
		$sql = "SELECT o.order_id,o.store_id,o.mail_status, CONCAT(o.firstname, ' ', o.lastname) AS customer, (SELECT os.name FROM " . DB_PREFIX . "order_status os WHERE os.order_status_id = o.order_status_id AND os.language_id = '" . (int)$this->config->get('config_language_id') . "') AS order_status, o.shipping_code, o.total, o.currency_code, o.currency_value, o.date_added, o.date_modified FROM `" . DB_PREFIX . "order` o";
		...
		if (isset($data['filter_order_status'])) {
			...
			$sql .= " WHERE o.order_status_id > '0'";
				...
				if (isset($data['filter_invoicestatus']) && !is_null($data['filter_invoicestatus'])) {
					$sql .= " AND mail_status = '" . (int)$data['filter_invoicestatus'] . "'";
				}
